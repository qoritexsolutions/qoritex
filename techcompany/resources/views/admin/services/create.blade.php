        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control" value="{{ old('title') }}" placeholder="e.g., Web Development" required>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="icon" name="icon" class="form-control" value="{{ old('icon', 'fas fa-code') }}" placeholder="e.g., fas fa-code" required>
                        ...
                        <div class="icon-preview" id="iconPreview">
                            <i class="{{ old('icon', 'fas fa-code') }}"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="short_description" name="short_description" class="form-control" value="{{ old('short_description') }}" placeholder="Brief one-line description (shown in cards)" maxlength="150">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="6" placeholder="Detailed description of the service..." required>{{ old('description') }}</textarea>
                    @error('description')
                    <p style="color: var(--danger); font-size: 0.85rem; margin-top: 0.5rem;">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="form-section">
                ...
                <div class="features-container" id="featuresContainer">
                    <div class="feature-input">
                        <input type="text" name="features[]" class="form-control" placeholder="e.g., Custom design tailored to your brand">
                    </div>
                    <div class="feature-input">
                        <input type="text" name="features[]" class="form-control" placeholder="e.g., Responsive across all devices">
                    </div>
                    <div class="feature-input">
                        <input type="text" name="features[]" class="form-control" placeholder="e.g., SEO optimized from the start">
                    </div>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="starting_price" name="starting_price" class="form-control" placeholder="e.g., 999" min="0" step="0.01">
                    </div>
                    <div class="form-group">
                        <label for="price_note">Price Note</label>
                        <input type="text" id="price_note" name="price_note" class="form-control" placeholder="e.g., Starting from">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="meta_title" name="meta_title" class="form-control" value="{{ old('meta_title') }}" placeholder="Custom title for search engines (leave blank to use service title)">
                </div>
                <div class="form-group">
                    <label for="meta_description">Meta Description</label>
                    <textarea id="meta_description" name="meta_description" class="form-control" rows="3" placeholder="Description for search engine results (150-160 characters recommended)">{{ old('meta_description') }}</textarea>
                </div>
            </div>
...
function addFeature() {
    ...
    const featureCount = container.querySelectorAll('.feature-input').length;
